...
@push('modal')
    <form method="post" action="/challenge" data-title="Input Data Challenge" data-reload="">
        <div class="mb-3">
            <label for="title" class="form-label">Judul Challenge</label>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="estimated" class="form-control" id="estimated" placeholder="Masukkan Estimasi Waktu (satuan jam)">
        </div>
        <div class="mb-3">
            <label for="day" class="form-label">Target Challenge</label>
            <input type="number" name="day" class="form-control" id="day" placeholder="Masukkan Target (satuan hari)">
        </div>
        <div class="mb-3">
            <label for="images" class="form-label">Thumbnail Challenge</label>
            <input type="file" name="images" class="form-control" id="images" placeholder="Masukkan Thumbnail Challenge">
        </div>
        <div class="mb-3">
